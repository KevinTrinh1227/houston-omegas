  ...
  const Step2 = () => (
    <div className="px-8 pb-8 pt-4">
      ...
      <div className="space-y-3 mb-6">
        <div>
          <label className="block text-[11px] uppercase tracking-wider text-dash-text-muted mb-1">Phone <span className="text-red-400">*</span></label>
      ...
      <div className="flex gap-3">
        ...
        <button type="button" onClick={() => { if (validateStep2()) setStep(3); }} className={`flex-1 ${PRIMARY_BTN}`}>Continue</button>
      </div>
    </div>
  );
